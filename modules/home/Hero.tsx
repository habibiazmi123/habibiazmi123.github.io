...
const Hero = () => {
  ...
  return (
    <section className='relative overflow-hidden'>
      ...
      >
        <div className='font-black uppercase text-[340px] md:text-[730px] text-stroke text-stroke-primary text-transparent select-none opacity-50'>
          Azmi
        </div>
      </div>
      <div
      ...
      <ContentWrapper extraClass='px-6 md:px-32 py-24'>
        ...
        >
          ...
          <p className='font-medium text-xl md:text-2xl'>
            <a href='mailto:habibiazmi.m@gmail.com'>E-MAIL</a>
          </p>
        </section>
      </ContentWrapper>
    </section>
